...
export const Banner = () => {
    return (
        <div className="max-w-screen-2xl container mx-auto  md:px-20 mr-3 my-10 md:flex mb-3">
            <div className="order-1 md:order-2 w-full md:w-1/2">
                <img src={bookBanner} className="w-92 h-92 rounded-md" alt="BookBanner" />
            </div>
            <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32 mx-2">
                <div className="space-y-12">
                    ...
                    <button className="btn btn-secondary ml-3 md:ml-2 mt-6">Get Start</button>
            </div>
